...
namespace MUtils.MessageBroker.RabbitMq.Impl
{
    public class RabbitSubScriber : ISubscriber
    {
        ...
        public RabbitSubScriber(ISerializer serializer, Server server, Queue queue, Action<Result<string>> reciever, bool autoAck = false, Action shutDownAction = null)
        {
        ...
        public Action<Result<string>> Recievers { get; set; }
        ...
        private void ConsumerReceived(object sender, BasicDeliverEventArgs e)
        {
            ...
            RabbitResult<string> item = new RabbitResult<string>(jsonData, e.DeliveryTag, _channel);
    ...
    public class RabbitSubScriber<T> : ISubscriber<T>
    {
        private readonly Server _server = null;
        private readonly Queue _queue = null;
        //private readonly Qos _qos = null;
        ...
        Action<Result<string>> ISubscriber.Recievers { get; set; }
