...
namespace MUtils.CqrsBase {
    internal static class QueryHandlersCache<TQuery, TResult> where TQuery : IQuery<TResult> {
        ...
        .Lambda #Lambda1<System.Func`3[System.Object,MUtils.CqrsBase.IQuery`1[System.Nullable`1[System.Int64]],System.Nullable`1[System.Int64]]>(
            ...
            .Block(MUtils.CqrsBase.Tests.GetUserIdQueryHandler $instance) {
                $instance = (MUtils.CqrsBase.Tests.GetUserIdQueryHandler)$handler;
                .Call $instance.Handle((MUtils.CqrsBase.Tests.GetUserIdQuery)$query)
            }
        }
        */
